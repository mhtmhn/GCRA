...
//datatypes
enum armpart{waist,shoulder,elbow,wrist_p,wrist_r,tool};	//parts of robotic arm. Note:wrist_p=wrist pitch,wrist_r=wrist roll in actuate()
...
void actuate(armpart,int);	//actuate(part to actuate,angle to snap to)
